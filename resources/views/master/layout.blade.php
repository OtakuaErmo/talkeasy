          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu"  style="width: 800px">
                <div class="card-body" >
                    ...
                    <p class="card-text">LIBRAS significa Língua Brasileira de Sinais. É uma língua gestual-visual que permite se comunicar
                        por meio de gestos, expressões faciais e corporais.
                        É muito utilizada na comunicação com pessoas surdas, sendo uma importante ferramenta de inclusão social.
                    </p>
                  </div>
          </li>
        </ul>
